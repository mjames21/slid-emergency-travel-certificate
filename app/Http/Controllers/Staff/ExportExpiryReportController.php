<?php
// FILE: app/Http/Controllers/Staff/ExportExpiryReportController.php
...
class ExportExpiryReportController extends Controller
{
    ...
    protected function buildExport(
        ...
        if ($scope === 'expired_active') {
            ...
            return [
                'staff-expired-active-permits-' . now()->format('Ymd-His') . '.csv',
                $query,
            ];
        }
        ...
        if ($startDate !== null && $endDate !== null) {
            ...
            return [
                'staff-expiring-range-permits-' . now()->format('Ymd-His') . '.csv',
                $query,
            ];
        }
        ...
        return [
            'staff-expiring-soon-permits-' . now()->format('Ymd-His') . '.csv',
            $query,
        ];
    }
