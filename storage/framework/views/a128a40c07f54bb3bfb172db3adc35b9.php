    ...
    <div class="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="overflow-hidden rounded-2xl bg-white shadow">
            ...
            <div class="space-y-6 px-6 py-6">
                <div class="rounded-xl border px-4 py-4 <?php echo e($statusClasses); ?>">
                    <div class="text-xs uppercase tracking-wide">Verification Status</div>
                    <div class="mt-1 text-2xl font-bold"><?php echo e($publicStatus); ?></div>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($searchedPermit->id !== $permit->id): ?>
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    <div class="rounded-xl border border-gray-200 p-4">
                        ...
                        <div class="mt-1 text-lg font-semibold text-gray-900"><?php echo e($searchedPermit->permit_no); ?></div>
                    </div>

                    <div class="rounded-xl border border-gray-200 p-4">
                        <div class="text-sm text-gray-500">Displayed Permit Number</div>
                        <div class="mt-1 text-lg font-semibold text-gray-900"><?php echo e($permit->permit_no); ?></div>
                    </div>

                    <div class="rounded-xl border border-gray-200 p-4">
                        <div class="text-sm text-gray-500">Traveler</div>
                        <div class="mt-1 font-semibold text-gray-900">
                            <?php echo e($permit->visaApplication->passenger->full_name ?? '—'); ?>
                    ...
                    <div class="rounded-xl border border-gray-200 p-4">
                        ...
                        <div class="mt-1 font-semibold text-gray-900">
                            <?php echo e($permit->visaApplication->passenger->passport_number ?? '—'); ?>
                    ...
                    <div class="rounded-xl border border-gray-200 p-4">
                        ...
                        <div class="mt-1 font-semibold text-gray-900">
                            <?php echo e(optional($permit->valid_until)->format('Y-m-d') ?: '—'); ?>
...
</html><?php /**PATH /Users/mohamedjames/Documents/SLID/slid-emergency-travel-certificate/resources/views/verify/permit.blade.php ENDPATH**/ ?>