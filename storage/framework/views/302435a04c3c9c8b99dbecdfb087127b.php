...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
            ...
            <p class="text-sm text-gray-600"><?php echo e($invoice->invoice_no); ?></p>
        </div>

        <div class="flex flex-wrap gap-3">
            <a href="<?php echo e(route('documents.invoices.show', $invoice)); ?>"
               target="_blank"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $isPaid && $wangovEnabled): ?>
                <button
                    type="button"
                ...
                >
                    <span wire:loading.remove wire:target="startWangovCheckout">
                        <?php echo e($isInitiated ? 'Refresh WanGov Checkout' : 'Start WanGov Checkout'); ?>
        ...
        <div class="rounded-xl bg-white p-6 shadow lg:col-span-2">
            ...
            <div class="mt-4 grid gap-4 md:grid-cols-2">
                <div>
                    ...
                    <div class="font-medium text-gray-900"><?php echo e($invoice->invoice_no); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Payment Reference</div>
                    <div class="font-medium text-gray-900"><?php echo e($invoice->payment_reference); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Status</div>
                    <div class="font-medium text-gray-900"><?php echo e(strtoupper($invoice->status->value)); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Gateway</div>
                    <div class="font-medium text-gray-900"><?php echo e(strtoupper($invoice->gateway)); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Amount</div>
                    <div class="font-medium text-gray-900"><?php echo e(number_format((float) $invoice->amount, 2)); ?> <?php echo e(strtoupper($invoice->currency)); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Issued At</div>
                    <div class="font-medium text-gray-900"><?php echo e(optional($invoice->issued_at)->format('Y-m-d H:i') ?: '—'); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Expires At</div>
                    <div class="font-medium text-gray-900"><?php echo e(optional($invoice->expires_at)->format('Y-m-d H:i') ?: '—'); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Paid At</div>
                    <div class="font-medium text-gray-900"><?php echo e(optional($invoice->paid_at)->format('Y-m-d H:i') ?: '—'); ?></div>
                </div>
            </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $isPaid): ?>
                <div class="mt-8 rounded-xl border border-emerald-200 bg-emerald-50 p-5">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canConfirmNraReceipt): ?>
                        <form wire:submit.prevent="recordNraReceiptPayment" class="mt-5 grid gap-4 lg:grid-cols-2">
                            <div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manual_receipt_no'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    <div class="mt-1 text-xs font-semibold text-red-700"><?php echo e($message); ?></div>
                                <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($manual_receipt_image): ?>
                                    <p class="mt-1 text-xs font-semibold text-emerald-900">
                                        Selected: <?php echo e($manual_receipt_image->getClientOriginalName()); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manual_receipt_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="lg:col-span-2">
                                ...
                                ></textarea>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['manual_receipt_note'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="mt-4 rounded-xl border border-gray-200 bg-gray-50 p-5">
                    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                        <div class="flex-1">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wangovEnabled): ?>
                                <div class="mt-4 max-w-md">
                                    ...
                                    <input
                                        ...
                                        placeholder="+232..."
                                    >
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['payer_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="mt-4 grid gap-4 md:grid-cols-2">
                <div>
                    ...
                    <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->application_no); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Point of Entry</div>
                    <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->point_of_entry); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Purpose of Visit</div>
                    <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->purpose_of_visit); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Period of Stay</div>
                    <div class="font-medium text-gray-900">
                        <?php echo e($invoice->visaApplication->period_of_stay_text ?: $invoice->visaApplication->period_of_stay_days . ' days'); ?>
                ...
                <div>
                    ...
                    <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->airport->name); ?></div>
                </div>

                <div>
                    <div class="text-sm text-gray-500">Desk</div>
                    <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->desk?->name ?: '—'); ?></div>
                </div>
            </div>
        </div>
            ...
            <div class="rounded-xl bg-white p-6 shadow">
                ...
                <div class="mt-4 space-y-3">
                    <div>
                        ...
                        <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->passenger->full_name); ?></div>
                    </div>

                    <div>
                        <div class="text-sm text-gray-500">Passport Number</div>
                        <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->passenger->passport_number); ?></div>
                    </div>

                    <div>
                        <div class="text-sm text-gray-500">Nationality</div>
                        <div class="font-medium text-gray-900"><?php echo e($invoice->visaApplication->passenger->nationality); ?></div>
                    </div>

                    <div>
                        <div class="text-sm text-gray-500">Passport Expiry</div>
                        <div class="font-medium text-gray-900">
                            <?php echo e(optional($invoice->visaApplication->passenger->passport_expiry_date)->format('Y-m-d') ?: '—'); ?>
            ...
            <div class="rounded-xl bg-white p-6 shadow">
                ...
                <div class="mt-4 space-y-3">
                    <div>
                        ...
                        <?php $receipt = $invoice->payments->first(fn ($payment) => $payment->receipt !== null)?->receipt; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($receipt): ?>
                            <a href="<?php echo e(route('staff.receipts.show', $receipt)); ?>" class="font-medium text-gray-900 underline">
                                <?php echo e($receipt->receipt_no); ?>

                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($receipt->receipt_source === 'nra_manual'): ?>
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($invoice->visaApplication->permit && auth()->user()->can('view', $invoice->visaApplication->permit)): ?>
                            <a href="<?php echo e(route('staff.permits.show', $invoice->visaApplication->permit)); ?>" class="font-medium text-gray-900 underline">
                                <?php echo e($invoice->visaApplication->permit->permit_no); ?>

                            </a>
                        <?php elseif($invoice->visaApplication->permit): ?>
...
<?php /**PATH /Users/mohamedjames/Documents/SLID/slid-emergency-travel-certificate/resources/views/livewire/staff/invoices/show.blade.php ENDPATH**/ ?>